...
export default function FloorTilePanel({
  ...
  const colorPalette = [
    ...
    '#FF00FF', '#00FFFF', '#FFFFFF', '#000000'  // 추가색 (흰색, 검정 추가)
  ]
  ...
  return (
    <div className="space-y-4 pb-4 mx-4 mb-4">
      {/* 파일 업로드 (숨겨진 input) */}
      <input
        ref={fileInputRef}
        type="file"
      ...
      {/* 픽셀 에디터 */}
      <div className="space-y-4 p-4 bg-black/30 rounded-lg border border-white/20">
