        ...
        >
          ...
          <div className="p-4 sm:p-6">
            <div className="space-y-4 text-gray-300 text-sm leading-relaxed">
              <h4 className="text-white font-bold text-lg mb-3 font-mono">1. 개인정보의 수집 및 이용목적</h4>
              <p className="font-mono">배달킹은 서비스 제공을 위해 다음과 같은 개인정보를 수집하고 있습니다:</p>
              ...
              <h4 className="text-white font-bold text-lg mb-3 mt-6 font-mono">2. 개인정보의 보유 및 이용기간</h4>
              <p className="font-mono">회원 탈퇴 시까지 보유하며, 탈퇴 후 30일간 보관 후 파기됩니다.</p>
              
              <h4 className="text-white font-bold text-lg mb-3 mt-6 font-mono">3. 개인정보의 제3자 제공</h4>
              <p className="font-mono">법령에 따른 규정이나 수사 목적으로 법령에 정해진 절차와 방법에 따라 수사기관의 요구가 있는 경우를 제외하고는 개인정보를 제3자에게 제공하지 않습니다.</p>
              
              <h4 className="text-white font-bold text-lg mb-3 mt-6 font-mono">4. 이용자 및 법정대리인의 권리</h4>
              <p className="font-mono">개인정보 열람, 정정, 삭제, 처리정지를 요구할 수 있으며, 이에 대해 지체 없이 조치하겠습니다.</p>
            </div>
