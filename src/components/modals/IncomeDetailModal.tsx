    ...
    >
      ...
      <PixelCard title="DATE" variant="primary">
        <div className="text-center">
          <div className="text-white font-bold text-lg font-mono mb-2">
      ...
      <PixelCard title="INCOME SUMMARY" variant="secondary">
        <div className="grid grid-cols-2 gap-2 sm:gap-3">
          ...
          <div className="bg-[#1a202c]/50 p-2 sm:p-3 rounded-lg text-center border"
            ...
            <div className="text-white text-xs font-mono font-bold mb-1">총 건수</div>
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    <div className="text-gray-300 font-mono">
                      배달비: ₩{(record.amount || 0).toLocaleString()}
                    </div>
                    <div className="text-gray-300 font-mono">
                      미션비: ₩{(record.missionAmount || 0).toLocaleString()}
                    </div>
                  </div>
                </div>
              )
